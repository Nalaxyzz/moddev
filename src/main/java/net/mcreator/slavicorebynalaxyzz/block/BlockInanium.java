...
public class BlockInanium extends ElementsSlavicoreMod.ModElement {
	@GameRegistry.ObjectHolder("slavicore:inanium")
	public static final Block block = null;
	public BlockInanium(ElementsSlavicoreMod instance) {
		super(instance, 26);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("inanium"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("slavicore:inanium", "inventory"));
	}

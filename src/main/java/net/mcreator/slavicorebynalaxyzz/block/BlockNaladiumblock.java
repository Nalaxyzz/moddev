...
import net.mcreator.slavicorebynalaxyzz.item.ItemNaladiumingot;
...
public class BlockNaladiumblock extends ElementsSlavicoreMod.ModElement {
	@GameRegistry.ObjectHolder("slavicore:naladiumblock")
	public static final Block block = null;
	public BlockNaladiumblock(ElementsSlavicoreMod instance) {
		super(instance, 52);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("naladiumblock"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("slavicore:naladiumblock", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		public BlockCustom() {
			super(Material.IRON);
			setUnlocalizedName("naladiumblock");
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemNaladiumingot.block, (int) (1)));
		}
	}
}
